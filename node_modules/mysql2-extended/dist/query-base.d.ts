...
import type { BindValue, QueryInterface, Condition, Opts, OrderBy, Row, Col } from './types';
export declare class QueryBase implements QueryInterface {
    protected driver: Pool | Connection | PoolConnection;
    constructor(driver: Pool | Connection | PoolConnection);
    ...
    protected getConnection(): Promise<Connection | PoolConnection>;
    protected closeConnection(con: Connection | PoolConnection): Promise<void>;
